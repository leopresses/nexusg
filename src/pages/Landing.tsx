      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="container mx-auto relative">
          <motion.div className="max-w-4xl mx-auto text-center" initial="hidden" animate="visible" variants={stagger}>
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary border border-border shadow-sm mb-8"
            >
              <Zap className="h-4 w-4 text-primary" />
              <span className="text-sm text-muted-foreground">A plataforma #1 para gestão de Google Business</span>
            </motion.div>

            <motion.h1 variants={fadeInUp} className="text-4xl md:text-6xl lg:text-7xl font-display font-bold mb-6 leading-tight text-foreground">
              Cresça no Google com{" "}
              <span className="text-gradient-neon">Gestão Nexus</span>
            </motion.h1>
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/register">
                <Button variant="hero" size="xl" className="w-full sm:w-auto rounded-xl">
                  Começar Gratuitamente
                  <ArrowRight className="h-5 w-5" />
                </Button>
              </Link>
              <Link to="/demo">
                <Button variant="glass" size="xl" className="w-full sm:w-auto rounded-xl">
                  Ver Demonstração
                </Button>
              </Link>
            </motion.div>
        ...
        <div className="container mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-foreground">
              ...
              <span className="text-gradient-neon">dominar o Google</span>
            </h2>
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                key={index}
                variants={fadeInUp}
                className="p-6 rounded-2xl bg-card border border-border hover:border-primary/30 transition-all duration-300 group shadow-card"
              >
      ...
      <section className="py-20 px-6 relative">
        ...
        <div className="container mx-auto relative">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-4 text-foreground">
              Planos para cada{" "}
              <span className="text-gradient-neon">tamanho de negócio</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            {SIMPLE_PLANS.map((plan, index) => (
              ...
              >
                ...
                <div className="text-center">
                  <h3 className="text-lg font-display font-semibold mb-1 text-foreground">{plan.name}</h3>
                  <p className="text-sm text-muted-foreground mb-3">{plan.clients}</p>
                  <div className="text-xl font-display font-bold mb-4 text-foreground">{plan.price}</div>
                  <Link to="/register">
                    <Button
        ...
        <div className="container mx-auto">
          ...
          >
            ...
            <div className="relative">
              ...
              <Link to="/register">
                <Button size="xl" className="bg-background text-foreground hover:bg-background/90 rounded-xl font-semibold shadow-elevated">
