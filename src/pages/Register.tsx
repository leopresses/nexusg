...
const BENEFITS = ["1 cliente grátis para sempre", "Tarefas semanais automatizadas", "Relatórios em PDF"] as const;
...
function mapSupabaseError(msg: string): string {
  ...
  if (lower.includes("weak password") || lower.includes("password should"))
    return "Sua senha foi rejeitada pelo servidor. Use uma senha mais forte (letras, números e símbolos).";
...
export default function Register() {
  ...
  const handleSubmit = useCallback(
    ...
    [name, email, password, isLoading, signUp, toast, navigate],
  );
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-12 h-12 bg-white border-slate-200 rounded-xl shadow-sm focus-visible:ring-blue-600"
                  minLength={8}
                  required
                />
                <button
