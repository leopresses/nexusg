          ...
          >
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Adicione os estabelecimentos que você gerencia com informações básicas: nome, tipo de negócio, endereço
                e link do Google Business.
              </p>
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="h-5 w-5 text-success" />
                  <span>Vincule o perfil do Google Business</span>
                </li>
                <li className="flex items-center gap-3">
                  <CheckCircle2 className="h-5 w-5 text-success" />
